...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedRoles(): void
    {
        $roles = [
            ...
            ['name' => 'Kagawad', 'description' => 'Barangay council member', 'is_system_role' => 1],
            ['name' => 'SK Chairman', 'description' => 'Sangguniang Kabataan chairman', 'is_system_role' => 1],
            ['name' => 'Resident', 'description' => 'Regular resident', 'is_system_role' => 1],
            ['name' => 'Business Owner', 'description' => 'Registered business owner', 'is_system_role' => 0],
            ['name' => 'Purok Leader', 'description' => 'Leader of a purok', 'is_system_role' => 0],
        ];
    ...
    private function seedPermissions(): void
    {
        $permissions = [
            ...
            ['name' => 'create_residents', 'display_name' => 'Create Residents', 'module' => 'Residents'],
            ...
            ['name' => 'view_payments', 'display_name' => 'View Payments', 'module' => 'Finance'],
            ['name' => 'process_payments', 'display_name' => 'Process Payments', 'module' => 'Finance'],
            ['name' => 'generate_receipts', 'display_name' => 'Generate Receipts', 'module' => 'Finance'],
            
            // Announcements
            ['name' => 'view_announcements', 'display_name' => 'View Announcements', 'module' => 'Announcements'],
            ['name' => 'create_announcements', 'display_name' => 'Create Announcements', 'module' => 'Announcements'],
            ['name' => 'edit_announcements', 'display_name' => 'Edit Announcements', 'module' => 'Announcements'],
            ['name' => 'delete_announcements', 'display_name' => 'Delete Announcements', 'module' => 'Announcements'],
            
            // Blotters
            ['name' => 'view_blotters', 'display_name' => 'View Blotters', 'module' => 'Blotters'],
            ['name' => 'create_blotters', 'display_name' => 'Create Blotters', 'module' => 'Blotters'],
            ['name' => 'resolve_blotters', 'display_name' => 'Resolve Blotters', 'module' => 'Blotters'],
        ];
    ...
    private function seedRolePermissions(): void
    {
        ...
        $barangayCaptainRole = DB::table('roles')->where('name', 'Barangay Captain')->first();
        $secretaryRole = DB::table('roles')->where('name', 'Barangay Secretary')->first();
        $treasurerRole = DB::table('roles')->where('name', 'Barangay Treasurer')->first();
        $residentRole = DB::table('roles')->where('name', 'Resident')->first();
        ...
        // Assign specific permissions to Barangay Captain
        $captainPermissions = ['view_residents', 'create_residents', 'edit_residents', 
                               'view_announcements', 'create_announcements', 'edit_announcements',
                               'view_blotters', 'create_blotters', 'resolve_blotters'];
        
        foreach ($captainPermissions as $permName) {
        ...
        $secretaryPermissions = ['view_residents', 'create_residents', 'edit_residents', 
                                 'view_announcements', 'create_announcements',
                                 'view_blotters', 'create_blotters'];
        ...
        $treasurerPermissions = ['view_payments', 'process_payments', 'generate_receipts'];
        
        foreach ($treasurerPermissions as $permName) {
            $perm = $allPermissions->where('name', $permName)->first();
            if ($perm) {
                DB::table('role_permissions')->insert([
        ...
        // Resident basic permissions
        $residentPermissions = ['view_announcements'];
        
        foreach ($residentPermissions as $permName) {
            $perm = $allPermissions->where('name', $permName)->first();
            if ($perm) {
                DB::table('role_permissions')->insert([
    ...
    private function seedUsers(): void
    {
        $users = [
            ...
            [
                ...
                'role_id' => DB::table('roles')->where('name', 'Resident')->first()->id,
                'status' => 'active',
                'email_verified_at' => now(),
            ],
            [
            ...
            [
                ...
                'role_id' => DB::table('roles')->where('name', 'Business Owner')->first()->id,
                'status' => 'active',
                'email_verified_at' => now(),
            ],
        ];
    ...
    private function seedPositions(): void
    {
        ...
        $positions = [
            ...
            ['code' => 'POS-KAG1', 'name' => 'Kagawad - Peace and Order', 'description' => 'Council member for peace and order', 'order' => 4, 'role_name' => 'Kagawad', 'committee_code' => 'COM-PEACE'],
            ['code' => 'POS-KAG2', 'name' => 'Kagawad - Education', 'description' => 'Council member for education', 'order' => 5, 'role_name' => 'Kagawad', 'committee_code' => 'COM-EDU'],
            ['code' => 'POS-KAG3', 'name' => 'Kagawad - Health', 'description' => 'Council member for health', 'order' => 6, 'role_name' => 'Kagawad', 'committee_code' => 'COM-HEALTH'],
    ...
    private function seedOfficials(): void
    {
        ...
        $officials = [
            ...
            ['resident_name' => 'Jose Reyes', 'position_code' => 'POS-TREAS', 'term_start' => '2023-01-01', 'term_end' => '2025-12-31'],
            ...
            ['resident_name' => 'Maria Santos', 'position_code' => 'POS-SK', 'term_start' => '2023-01-01', 'term_end' => '2025-12-31'],
        ];
    ...
    private function seedAnnouncements(): void
    {
        $announcements = [
            ...
            [
                ...
                'end_time' => '17:00:00',
                'audience_type' => 'roles',
                'target_roles' => json_encode([DB::table('roles')->where('name', 'Resident')->first()->id]),
            ],
        ];
