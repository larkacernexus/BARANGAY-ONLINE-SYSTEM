...
Route::get('/', function () {
    ...
    Route::get('receipts/create', [ReceiptsController::class, 'create'])->name('receipts.create'); // Show create form
    Route::get('receipts/{receipt}', [ReceiptsController::class, 'show'])->name('receipts.show'); // View receipt
    Route::post('receipts/{receipt}/print', [ReceiptsController::class, 'print'])->name('receipts.print');


    
    // Receipt routes
    Route::get('/resident/receipts', [ResidentReceiptController::class, 'index'])->name('receipts.index');
    Route::get('/resident/receipts/{receipt}', [ResidentReceiptController::class, 'show'])->name('receipts.show');
    Route::get('/resident/receipts/{receipt}/download', [ResidentReceiptController::class, 'download'])->name('receipts.download');
    Route::post('/resident/receipts/{receipt}/print', [ResidentReceiptController::class, 'print'])->name('receipts.print');
...
Route::middleware(['auth', 'verified', 'admin'])->group(function () {
    ...
    Route::middleware('permission:manage-payments')->group(function () {
        Route::prefix('payments')->group(function () {
            ...
            // Fixed: removed duplicate /payments
    ...
    Route::middleware('permission:manage-fees')->group(function () {
        Route::prefix('fees')->group(function () {
            // Create - Fixed: removed duplicate /fees
    ...
    Route::middleware('permission:manage-report-types')->group(function () {
        Route::prefix('report-types')->group(function () {
            // Fixed: removed duplicate /report-types
    ...
    Route::middleware('permission:manage-fee-types')->group(function () {
        Route::prefix('fee-types')->name('fee-types.')->group(function () {
            // Fixed: removed duplicate /fee-types
    ...
    Route::middleware('permission:manage-clearances')->group(function () {
        Route::prefix('clearances')->name('clearances.')->group(function () {
            // Fixed: removed duplicate /clearances
    ...
    Route::middleware('permission:manage-clearance-types')->group(function () {
        Route::prefix('clearance-types')->name('clearance-types.')->group(function () {
            // Fixed: removed duplicate /clearance-types
    ...
    // Receipt routes
     Route::get('receipts', [ReceiptsController::class, 'index'])->name('receipts.index');      // List receipts
    Route::post('receipts', [ReceiptsController::class, 'store'])->name('receipts.store');     // Store new receipt
    
    // Additional receipt operations
    Route::post('receipts/generate-from-payment/{payment}', [ReceiptsController::class, 'generateFromPayment'])->name('receipts.generate-from-payment');
    Route::post('receipts/generate-from-clearance/{clearance}', [ReceiptsController::class, 'generateFromClearance'])->name('receipts.generate-from-clearance');
    Route::post('receipts/{receipt}/void', [ReceiptsController::class, 'void'])->name('receipts.void');
    
    // Optional: Bulk operations and export
    Route::post('receipts/bulk/operation', [ReceiptsController::class, 'bulkOperation'])->name('receipts.bulk-operation');
    Route::post('receipts/export', [ReceiptsController::class, 'export'])->name('receipts.export');
});
...
|--------------------------------------------------------------------------
*/
// CHANGED: 'resident' to 'portal' to match bootstrap/app.php
...
// Admin incident routes (outside resident group)
Route::middleware(['auth', 'verified', 'admin'])->group(function () {
    ...
    Route::patch('/admin/incidents/{incident}/status', [AdminIncidentController::class, 'updateStatus'])
        ->middleware('permission:manage-incidents')
        ->name('admin.incidents.update-status');
    ...
    Route::patch('/admin/blotters/{incident}/details', [AdminIncidentController::class, 'updateBlotterDetails'])
        ->middleware('permission:manage-blotters')
        ->name('admin.blotters.update-details');
});
