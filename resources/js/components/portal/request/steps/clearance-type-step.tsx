...
export function ClearanceTypeStep({
    ...
    return (
        <div className="space-y-6">
                ...
                {viewMode === 'list' ? (
                    ...
                    <div className="space-y-3">
                        {categorizedTypes.length > 0 ? (
                                ...
                                <button
                                    ...
                                    className={`w-full text-left p-4 rounded-xl border-2 transition-all ${
                                        dataClearanceTypeId === type.id.toString()
                                            ? 'border-blue-500 bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/30 dark:to-gray-800 ring-2 ring-blue-500/20'
                                            : 'border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-gray-600 bg-white dark:bg-gray-900'
                                    }`}
                            ...
                            <div className="text-center py-8 px-4 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900">
                                <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 bg-blue-100 dark:bg-blue-900/30 text-blue-500 dark:text-blue-400">
                                    <FileCheck className="h-6 w-6" />
                                </div>
                                <h4 className="font-medium mb-1 text-gray-900 dark:text-white">No clearance types found</h4>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {categorizedTypes.length > 0 ? (
                            categorizedTypes.slice(0, visibleCount).map((type) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-1 flex-wrap">
                                        {type.category && (
                                            <Badge variant="outline" className="text-[10px] px-1.5 py-0 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-700">
                                                {type.category}
                                            </Badge>
                                        )}
                                        {type.formatted_fee && type.formatted_fee !== '₱0.00' && (
                                        ...
                                        {type.document_types?.some(doc => doc.is_required) && (
                                            <Badge variant="outline" className="text-[10px] px-1.5 py-0 bg-red-50 dark:bg-red-950/30 text-red-700 dark:text-red-400 border-red-200 dark:border-red-800">
                                                Docs Required
                                            </Badge>
                                        )}
                                    </div>
                            ...
                            <div className="col-span-2 text-center py-8 px-4 border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-900">
                                <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 bg-blue-100 dark:bg-blue-900/30 text-blue-500 dark:text-blue-400">
                                    <FileCheck className="h-6 w-6" />
                                </div>
                                <h4 className="font-medium mb-1 text-gray-900 dark:text-white">No clearance types found</h4>
                ...
                <Card className="rounded-xl border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                    <CardContent className="p-3">
                        <div className="flex items-center gap-2 overflow-x-auto py-1">
                            <span className="text-xs font-medium text-gray-500 dark:text-gray-400 whitespace-nowrap">Jump to:</span>
            ...
            {selectedClearance && (
                <div className="mt-4 p-4 rounded-lg border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950/30">
                    <div className="flex items-start justify-between">
                            ...
                            <div>
                                <h4 className="font-semibold flex items-center gap-2 flex-wrap text-gray-900 dark:text-white">
                                    ...
                                    {selectedClearance.category && (
                                        <Badge variant="outline" className="text-xs bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border-gray-200 dark:border-gray-700">
                                            {selectedClearance.category}
                                        </Badge>
                                    )}
                        ...
                        <Button
                            ...
                            className="h-8 w-8 p-0 flex-shrink-0 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                        >
                            <X className="h-4 w-4" />
                        </Button>
                    </div>
                    <div className="grid grid-cols-3 gap-2 mt-3 text-xs">
                        ...
                        <div className="text-center p-2 bg-white dark:bg-gray-800 rounded border border-gray-100 dark:border-gray-700">
                            <div className="font-medium text-gray-900 dark:text-white">Validity</div>
                        ...
                        <div className="text-center p-2 bg-white dark:bg-gray-800 rounded border border-gray-100 dark:border-gray-700">
                            ...
                            <div className={selectedClearance.document_types?.some(doc => doc.is_required) ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400'}>
