...
interface EvidenceThumbnailProps {
    ...
    canEdit: boolean;
    isDeleting?: number | null; // Changed to number | null to track which evidence is deleting
}
        ...
        <div className="relative group cursor-pointer active:scale-[0.98] transition-all duration-300">
            {isImage ? (
                <div 
                    ...
                    onClick={() => onView(evidence.file_url || evidence.file_path)}
                >
                    <img
                        src={evidence.file_url || evidence.file_path}
