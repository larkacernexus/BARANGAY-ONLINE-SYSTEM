// components/admin/report-types/ReportTypesBulkActions.tsx
...
export default function ReportTypesBulkActions({
    selectedReportTypes,
    selectionMode,
    selectionStats,
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {setShowBulkPriorityDialog && (
                            <Tooltip>
                                ...
                                <TooltipContent>
                                    Bulk edit report type priorities
                                </TooltipContent>
                            </Tooltip>
                        )}
                    </div>
                ...
                <div className="mt-3 pt-3 border-t border-blue-100 dark:border-blue-800">
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span>
                                {selectionStats.critical} critical • {selectionStats.high} high
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <Zap className="h-3.5 w-3.5 text-amber-500" />
                            <span>
                                {selectionStats.requiresImmediateAction} urgent
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <Clock className="h-3.5 w-3.5 text-green-500" />
                            <span>
                                {selectionStats.totalResolutionDays} total days
                            </span>
                        </div>
                    </div>
                    <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-gray-500">
                        <div className="flex items-center gap-1">
                            ...
                            <span>{selectionStats.requiresEvidence} require evidence</span>
                        </div>
                        <div className="flex items-center gap-1">
                            <User className="h-3 w-3" />
                            <span>{selectionStats.allowsAnonymous} allow anonymous</span>
                        </div>
                    </div>
                </div>
            )}
