...
import { Plus, MousePointer, Layers, FileText } from 'lucide-react';
...
export default function FormsHeader({ 
    ...
    return (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
            <div>
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight">Forms Management</h1>
                <p className="text-gray-500 dark:text-gray-400 text-xs sm:text-sm">
                    Manage downloadable forms and documents
                </p>
            </div>
