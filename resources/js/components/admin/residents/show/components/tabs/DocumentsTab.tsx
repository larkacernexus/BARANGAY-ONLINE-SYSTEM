// resources/js/Components/Admin/Residents/Show/Components/Tabs/DocumentsTab.tsx
                    ...
                    {filteredDocuments.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">
                                {searchQuery ? 'No documents match your search.' : 'This resident has no documents yet.'}
                            </p>
                        </div>
                    ) : (
