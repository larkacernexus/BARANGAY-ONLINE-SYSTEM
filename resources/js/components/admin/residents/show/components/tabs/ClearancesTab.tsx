// resources/js/Components/Admin/Residents/Show/Components/Tabs/ClearancesTab.tsx
            ...
            <Card className="dark:bg-gray-900">
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <Link href={route('admin.clearances.create', { resident_id: residentId })}>
                ...
                <CardContent>
                    {clearances.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">This resident has no clearance requests yet.</p>
                        </div>
                    ) : (
