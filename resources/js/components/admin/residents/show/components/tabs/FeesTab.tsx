// resources/js/Components/Admin/Residents/Show/Components/Tabs/FeesTab.tsx
...
export const FeesTab = ({ 
    ...
    const outstandingBalance = totalAmount - calculatedTotalPaid;
                ...
                <CardContent>
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-bold text-green-600 dark:text-green-400">{formatAmount(calculatedTotalPaid)}</span>
                        </div>
            ...
            <Card className="dark:bg-gray-900">
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <Link href={route('admin.fees.create', { resident_id: residentId })}>
                ...
                <CardContent>
                    {fees.length === 0 ? (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 dark:text-gray-400">This resident has no fee assessments yet.</p>
                        </div>
                    ) : (
