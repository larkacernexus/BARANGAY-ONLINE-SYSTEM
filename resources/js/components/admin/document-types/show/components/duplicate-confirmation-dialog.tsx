// resources/js/Pages/Admin/DocumentTypes/components/duplicate-confirmation-dialog.tsx
    ...
    return (
        <AlertDialog open={open} onOpenChange={onOpenChange}>
            <AlertDialogContent className="dark:bg-gray-900">
                <AlertDialogHeader>
                    <AlertDialogTitle className="dark:text-gray-100">Duplicate Document Type</AlertDialogTitle>
