...
interface UserAssignmentProps {
    ...
    selectedPosition: Position | null; // Changed from selectedPositionId
...
export function UserAssignment({ 
    ...
    const getPositionUsers = () => {
        ...
        // Match by position name or role_id
        return users.filter(u => 
            u.position === selectedPosition.name || // Exact position match
            u.role_id === selectedPosition.role_id || // Same role
            u.username?.toLowerCase().includes(selectedPosition.code.toLowerCase()) // Username contains position code
        );
    };
    ...
    return (
        <div className="space-y-4">
            {selectedPosition && positionUsers.length === 0 ? (
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Select a position first to see available position accounts.
                    </p>
                </div>
            ) : (
                <>
                    <div className="space-y-2">
                        <Label htmlFor="user_id" className="dark:text-gray-300">
