// components/admin/officials/OfficialsHeader.tsx
import { Button } from '@/components/ui/button';
import { Link } from '@inertiajs/react';
import { Layers, MousePointer, Plus, Shield } from 'lucide-react';
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/ui/tooltip';

interface OfficialsHeaderProps {
    isBulkMode: boolean;
...
export default function OfficialsHeader({
    ...
    setIsBulkMode,
    isMobile
}: OfficialsHeaderProps) {
    return (
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
                <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Barangay Officials</h1>
