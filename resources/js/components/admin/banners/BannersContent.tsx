// resources/js/components/admin/banners/BannersContent.tsx
...
import BannersTableView from '@/components/admin/banners/BannersTableView';
import BannersGridView from '@/components/admin/banners/BannersGridView';
import BannersBulkActions from '@/components/admin/banners/BannersBulkActions';
import { Banner, BannerFilters, BulkOperation } from '@/types/admin/banners/banner';
...
export default function BannersContent({
    ...
    sortOrder = 'desc',
    onSortChange = () => {},
    getCurrentSortValue = () => 'sort_order-desc'
}: BannersContentProps) {
        ...
        secondary: [
            {
                ...
                tooltip: 'Update status for selected banners'
            },
            {
                label: 'Copy Data',
        ...
        destructive: [
            {
                ...
                tooltip: 'Delete selected banners',
    ...
    return (
        <>
            ...
            {isBulkMode && selectedBanners.length > 0 && (
                <BannersBulkActions
            ...
            {viewMode === 'grid' && banners.length > 0 && selectedBanners.length < banners.length && isBulkMode && (
                <SelectAllFloat
                    isSelectAll={isSelectAll}
            ...
            <Card className="overflow-hidden border border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                <CardHeader className="flex flex-row items-center justify-between pb-3 p-4 sm:p-6 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2">
                            ...
                            <CardTitle className="text-base sm:text-lg md:text-xl font-semibold dark:text-gray-100">
                                Banner List
                                {selectedBanners.length > 0 && isBulkMode && (
                    ...
                    <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    ...
                                    <SelectContent>
                                        ...
                                        <SelectItem value="sort_order-asc">Order (Low to High)</SelectItem>
                                        <SelectItem value="sort_order-desc">Order (High to Low)</SelectItem>
                        ...
                        {viewMode === 'grid' && isBulkMode && banners.length > 0 && (
                            <div className="flex items-center gap-2">
                                <Checkbox
                                    id="select-all-grid"
                                    checked={isSelectAll}
                    ...
                    {banners.length === 0 ? (
                        <EmptyState
                            ...
                            description={hasActiveFilters 
                                ? "No banners match your current filters. Try adjusting your search or filters."
                        ...
                        <>
                            ...
                            {viewMode === 'grid' && isBulkMode && selectedBanners.length > 0 && (
