...
interface PuroksBulkActionsProps {
...
export default function PuroksBulkActions({
    selectedPuroks,
    selectionMode,
    selectionStats,
                ...
                <div className="mt-3 pt-3 border-t border-blue-100 dark:border-blue-800">
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-sm">
                        <div className="flex items-center gap-2">
                            ...
                            <span>
                                {selectionStats.total || selectedPuroks.length} puroks
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <Home className="h-3.5 w-3.5 text-green-500" />
                            <span>
                                {selectionStats.totalHouseholds?.toLocaleString() || '0'} households
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                            <Users className="h-3.5 w-3.5 text-purple-500" />
                            <span>
                                {selectionStats.totalResidents?.toLocaleString() || '0'} residents
                            </span>
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    {selectionStats.hasLeaders !== undefined && (
                        <div className="mt-2 grid grid-cols-2 gap-2 text-xs text-gray-500">
                            ...
                            <div className="flex items-center gap-1">
                                ...
                                <span>{selectionStats.hasMaps || 0} with maps</span>
                            </div>
                        </div>
                    )}
                </div>
