...
// Updated Notification interface to match middleware data
...
// Modern Notification Center Component
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent side="right" className="w-full sm:max-w-md p-0">
        ...
        {/* All Notifications Button - FIXED: Added margin bottom and proper styling */}
...
// Modern User Menu Component (unchanged)
const UserMenu = ({ 
  user, 
  residentData, 
  householdData,
