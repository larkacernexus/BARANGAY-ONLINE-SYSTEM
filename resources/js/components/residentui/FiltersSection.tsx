...
export function FiltersSection({
    ...
    exportToCSV,
    isExporting,
    getCurrentTabPayments = () => [], // Added default value
    hasActiveFilters,
    handleClearFilters,
    isMobile,
    setShowFilters
                        ...
                        <div>
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    className="flex-1"
                                    disabled={!getCurrentTabPayments().length}
                                >
                                ...
                                <Button
                                    ...
                                    size="sm"
                                    onClick={exportToCSV}
                                    disabled={isExporting || !getCurrentTabPayments().length}
                                    className="flex-1"
                                >
                                    {isExporting ? (
