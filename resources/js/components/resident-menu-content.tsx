...
interface ResidentMenuContentProps {
    user: User;
    Link?: React.ComponentType<InertiaLinkProps>;
}

export function ResidentMenuContent({ user, Link }: ResidentMenuContentProps) {
    const cleanup = useMobileNavigation();
    
    // Hardcoded URLs
    const LOGOUT_URL = '/logout';
    const RESIDENT_PROFILE_SETTINGS_URL = '/residentsettings/profile';
    
    console.log('Logout URL:', LOGOUT_URL);
    console.log('Profile settings URL:', RESIDENT_PROFILE_SETTINGS_URL);
    ...
    const handleSettingsClick = (e: React.MouseEvent) => {
        ...
        // Navigate to resident profile settings
        router.get(RESIDENT_PROFILE_SETTINGS_URL);
    };
            ...
            <DropdownMenuGroup>
                <DropdownMenuItem asChild>
                    <LinkComponent
                        ...
                        href={RESIDENT_PROFILE_SETTINGS_URL}
                        prefetch={true}
